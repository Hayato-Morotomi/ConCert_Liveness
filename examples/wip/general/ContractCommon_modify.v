...
Ltac contract_simpl_step receive init :=
  ...
  | H : context[Blockchain_modify.receive] |- _ => unfold Blockchain_modify.receive in H; cbn in H
  | |- context[Blockchain_modify.receive] => unfold Blockchain_modify.receive; cbn
  | H : context[Blockchain_modify.init] |- _ => unfold Blockchain_modify.init in H; cbn in H
  | |- context[Blockchain_modify.init] => unfold Blockchain_modify.init; cbn
